...
//        Log.d("hu.tvarga.debug", "pos: " + position + " last focused: " + focusedPosition);
//        RecyclerView.ViewHolder focusedViewHolder = mRecyclerView.findViewHolderForLayoutPosition(focusedPosition);
//        if (focusedViewHolder == null) {
//            InputMethodManager imm = (InputMethodManager) mRecyclerView.getContext().getSystemService(Context.INPUT_METHOD_SERVICE);
...
//        }
    ...
    public static class DataObjectHolder extends RecyclerView.ViewHolder {
        ...
        public DataObjectHolder(View itemView, MyCustomOnKeyListener myCustomOnKeyListener, MyCustomOnFocusChangeListener myCustomOnFocusChangeListener) {
            super(itemView);
